...
export const frontmatter = {
  title: 'Using the Activity Workflow',
  description:
...
## Introduction to the Activity Workspace
...
<Callout type="tip">
  **Key tips for Stage 1:**
  - Start with biases you're most familiar with
  - Consider both technical and human factors
  - Use the "Needs Discussion" category for uncertain cases
  - Remember you need to categorise at least 10 cards to proceed
</Callout>
...
<Callout type="info">
  **Understanding the lifecycle phases:**
  - **Project Design:** Planning, problem formulation, and data procurement
  - **Model Development:** Data analysis, preprocessing, and model training
  - **System Deployment:** Implementation, monitoring, and maintenance
</Callout>
...
<Callout type="tip">
  **Writing effective rationales:**
  - Be specific to your use case (e.g., emergency department context)
  - Include real examples where possible
  - Consider both immediate and long-term impacts
  - Think about edge cases and vulnerable populations
</Callout>
...
<Callout type="warning">
  **Mitigation considerations:**
  - Some strategies require significant resources or expertise
  - Multiple strategies may be needed for high-risk biases
  - Consider dependencies between different mitigation approaches
  - Ensure strategies are feasible within your project constraints
</Callout>
